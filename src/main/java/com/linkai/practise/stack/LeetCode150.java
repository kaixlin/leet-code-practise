...
public class LeetCode150 {
    ...
    public static void example1() {
        String[] tokens = {"2", "1", "+", "3", "*"};
        int expected = 9;
        int actual = new LeetCode150().evalRPN(tokens);
    ...
    public int evalRPN(String[] tokens) {
        ...
        Integer tempResult, tempValue1, tempValue2;
        for (String token : tokens) {
            switch (token) {
                case "+":
                    tempValue1 = stack.pop();
                    tempValue2 = stack.pop();
                    tempResult =  tempValue2 + tempValue1;
